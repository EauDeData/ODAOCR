...
## Features
- Contact me for accessing +100 trained OCR models available in [the interactive model card](https://eaudedata.github.io/ODAOCR/model_card/model_card.html). Please, write `[ODAOCR]` in the subject.
